...
NVT stage. The standard formulation trajectory contains 1,000 frames written
every 1,000 simulation steps. With the 5 fs timestep, neighboring frames are
5 ps apart and the complete trajectory spans approximately 5 ns.
